...
def main():
    ...
    if funcid == '1':
        ...
        "/mnt/nfsi01/ttskpiraw/umts-nokia/aggregatorInput/staging/ttskpiagg_NOKIA_LTE_20170731_152109520_TMO/*.txt" /mnt/nfsi/ttskpicellex/CellExFromSinfo.pqz
        /mnt/nfsi01/ttskpiraw/umts-nokia/parquet /mnt/nfso01/ttskpiraw/umts-nokia/dbloaderInput
        '''
        if argvs < 9:
